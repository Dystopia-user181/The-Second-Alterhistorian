export function format(v, precision = 2, precisionBefore1000 = 2, small = false) {
...
export function formatX(value, places, placesUnder1000) {
	return `×${format(value, places, placesUnder1000)}`;
}

export function formatPow(value, places, placesUnder1000) {
	return `^${format(value, places, placesUnder1000)}`;
}

export function formatPercents(value, places) {
