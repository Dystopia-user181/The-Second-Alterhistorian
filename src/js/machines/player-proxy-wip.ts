...
// export const Pipes = {};
export interface PipeConnectionType<InputUpgrades extends string, OutputUpgrades extends string> {
...
export const Pipes: Record<TownType, PipeConnectionType<string, string>[]> = {
	home: [],
};